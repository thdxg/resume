...
// Body
// ============================================================================
I am a developer who works across the stack from low-level systems to user-facing products. Most of my recent focus has been into Huddle Surety, where I'm founding engineer and CTO. Leading a team of engineers, I've architected an AI-native platform that automates surety bond issuance in Go, TypeScript, and Python. I shipped the frontend using TypeScript and React, built 100+ REST API endpoints with Go and Postgres, and managed CI/CD pipelines in a Kubernetes cluster. Whichever part of the stack I was working on, I cared most about reliability and performance.

Outside work, I enjoy building close to the metal, such as building a terminal emulator or running a Kubernetes homelab on Raspberry Pis. I've also contributed to tools like Next.js, Kubernetes, and Echo as an avid user as I find gaps while working with them. Working in open source has helped me mature as an engineer with discipline and rigor, as users around the world rely on software I built.
